object F_vendasConsulta: TF_vendasConsulta
  ...
  object Panel5: TPanel
    ...
    object lkcbox_formapag_ConsultarVendas: TDBLookupComboBox
      Left = 544
      Top = 25
      Width = 145
      Height = 21
      KeyField = 'forma_nome'
      ListField = 'forma_nome'
      ListSource = dm.ds_formapag
      TabOrder = 6
    end
  end
