object dm: Tdm
  ...
  object Report_reciboPedidoLancamento1: TppReport
    AutoStop = False
    DataPipeline = ppDB_Recibo_Lancamento
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    PrinterSetup.PaperName = 'A4'
    PrinterSetup.PrinterName = 'Default'
  ...
  object Report_reciboPedidoLancamento: TppReport
    AutoStop = False
    DataPipeline = ppDB_Recibo_Lancamento
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
  ...
  object TB_formapag: TFDTable
    IndexFieldNames = 'forma_id'
    MasterSource = ds_formapag
    Connection = conexao
    UpdateOptions.UpdateTableName = 'aguiarsvendasbd.forma_pagamento'
    TableName = 'aguiarsvendasbd.forma_pagamento'
    Left = 192
    Top = 184
    object TB_formapagforma_id: TFDAutoIncField
      FieldName = 'forma_id'
      Origin = 'forma_id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object TB_formapagforma_nome: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'forma_nome'
      Origin = 'forma_nome'
      Size = 40
  ...
  object SQL_usuario: TFDQuery
    ...
    Left = 24
    Top = 304
    object SQL_usuariouser_id: TFDAutoIncField
      FieldName = 'user_id'
      Origin = 'user_id'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object SQL_usuariouser_nome: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'user_nome'
      Origin = 'user_nome'
      Size = 100
    end
    object SQL_usuariouser_nome_completo: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'user_nome_completo'
      Origin = 'user_nome_completo'
      Size = 100
    end
    object SQL_usuariouser_senha: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'user_senha'
      Origin = 'user_senha'
      Size = 100
