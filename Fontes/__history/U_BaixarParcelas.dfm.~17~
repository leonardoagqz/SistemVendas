object F_baixarparcelas: TF_baixarparcelas
  ...
  object btn_pagarParcela: TBitBtn
    Left = 450
    Top = 293
    Width = 94
    Height = 25
  ...
  object SQL_ListarLancamentos: TFDQuery
    ...
    object SQL_ListarLancamentosparc_data_venc: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'parc_data_venc'
  ...
  object TB_baixarParcelas: TFDTable
    ...
    Connection = dm.conexao
    UpdateOptions.UpdateTableName = 'aguiarsvendasbd.parcelas'
    TableName = 'aguiarsvendasbd.parcelas'
    Left = 536
    Top = 288
    ...
    object TB_baixarParcelasparc_data_venc: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'parc_data_venc'
      Origin = 'parc_data_venc'
    end
